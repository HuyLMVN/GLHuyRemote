...
CXX_FLAGS:= -O3 -std=c++17 -stdlib=libc++ -g -Wall -Wextra -Wpedantic -Wdeprecated
C_FLAGS:= -O3 -std=c17 -g -Wall -Wextra -Wpedantic -Wdeprecated
LD_FLAGS:= ${CXX_FLAGS} ${C_FLAGS} -L/lib -lassimp -lglfw3 -lopengl32 -lkernel32 -lgdi32 -luser32
