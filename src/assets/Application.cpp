...
void Application::framebuffer_size_callback(GLFWwindow* window, int p_width, int p_height)
{
    glViewport(0, 0, p_width, p_height);
}

void Application::appFunc() {
	...
	Camera camera(&winWidth, &winHeight, glm::vec3(0.0f, 0.0f, 10.0f));
    shaderProgram.Activate();
